...
/**
 * Color Blind Utilities. These utilities help to show how color
 * blind/challenged see colors.
 *
 * Created by Thomas Wolfmaier. Copyright (C) 1999-2005 HCIRN. All rights
 * reserved.
 * 
...
public class ColorBlind {
	...
	private static final double[][] confusionPoints = { { 0.735, 0.265 }, { 1.140, -0.140 }, { 0.171, -0.003 } };
	private static final double[][][] colorAxes = { { { 0.115807, 0.073581 }, { 0.471899, 0.527051 } },
			{ { 0.102776, 0.102864 }, { 0.505845, 0.493211 } }, { { 0.045391, 0.294976 }, { 0.665764, 0.334011 } } };
	private static final double[][] RGBtoXYZMatrix = { { 0.430574, 0.341550, 0.178325 },
			{ 0.222015, 0.706655, 0.071330 }, { 0.020183, 0.129553, 0.939180 } };
	private static final double[][] XYZtoRGBMatrix = { { 3.063218, -1.393325, -0.475802 },
			{ -0.969243, 1.875966, 0.041555 }, { 0.067871, -0.228834, 1.069251 } };
