 ...
 *
 * @author Jorg Janke
 * @version $Id: CompiereToggleButtonUI.java,v 1.2 2006/07/30 00:52:24 jjanke
 *          Exp $
 */
public class CompiereToggleButtonUI extends MetalToggleButtonUI {
	...
	/**
	 * Update - This method is invoked by <code>JComponent</code> when the specified
	 * component is being painted.
	 *
	 * By default this method will fill the specified component with its background
	 * color (if its <code>opaque</code> property is <code>true</code>) and then
	 * immediately call <code>paint</code>.
	 *
