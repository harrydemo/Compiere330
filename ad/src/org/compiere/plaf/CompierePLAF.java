...
/**
 * Variable Pluggable Look And Feel. Provides an easy access to the required
 * currently active PLAF information
 *
 * @author Jorg Janke
...
public final class CompierePLAF {
	...
	/**
	 * Key of Client Property for Rectangle Items - if exists, the standard
	 * background is used
	 */
	...
	/**
	 * PLAF class list com.sun.java.swing.plaf.windows.WindowsLookAndFeel
	 * com.sun.java.swing.plaf.motif.MotifLookAndFeel
	 * javax.swing.plaf.metal.MetalLookAndFeel
	 * 
	 * /** Static Initializer. - Fill available PLAFs and Themes
	 */
	static {
...
//		themeList.add (new ValueNamePair("javax.swing.plaf.metal.MetalHighContrastTheme", "Java High Contrast"));
	...
	public static void setPLAF(ValueNamePair plaf, ValueNamePair theme, Window win) {
		...
		if (theme == null && laf instanceof MetalLookAndFeel) {
			...
			case "javax.swing.plaf.metal.MetalLookAndFeel":
				...
				break;
			case "org.compiere.plaf.CompiereLookAndFeel":
				theme = s_vp_compiereTheme;
				break;
			case "com.incors.plaf.kunststoff.KunststoffLookAndFeel":
	...
	public static void main(String[] args) {
		...
		if (!(jVersion.startsWith("1.8"))) {
			JOptionPane.showMessageDialog(null, "Require Java Version 1.8 or up - Not " + jVersion,
					"CompierePLAF - Version Conflict", JOptionPane.ERROR_MESSAGE);
			System.exit(1);
		}
