...
public final class Compiere {
	...
	/**
	 * 16*16 Product Image. /** Removing/modifying the Compiere logo is a violation
	 * of the license
	 */
	static private final String s_File16x16 = "images/C16.png";
	/**
	 * 32*32 Product Image. /** Removing/modifying the Compiere logo is a violation
	 * of the license
	 */
	static private final String s_file32x32 = "images/C32.png";
	/**
	 * 100*30 Product Image. /** Removing/modifying the Compiere logo is a violation
	 * of the license
	 */
	static private final String s_fileMedium = "images/Compiere120x30.png";
	/**
	 * 48*15 Product Image. /** Removing/modifying the Compiere logo is a violation
	 * of the license
	 */
	...
	/**
	 * Compiere is a wordwide registered Trademark - Don't modify this - Program
	 * will someday fail unexpectedly
	 */
	...
	/**
	 * Summary (Windows). Removing/modifying the Compiere copyright notice is a
	 * violation of the license Compiere(tm) Version 2.5.1a_2004-03-15 - Smart ERP &
	 * CRM - Copyright (c) 1999-2005 Jorg Janke; Implementation: 2.5.1a
	 * 20040417-0243 - (C) 1999-2005 Jorg Janke, ComPiere Inc. USA
	 * 
	...
	private static void setPackageInfo() {
		...
		/*
		 * harry 20181013 Package compierePackage = Package.getPackage("org.compiere");
	...
	public static String getEnvInfo(boolean isClient, String info) {
		...
		sb.append(getCompiereHome()).append(" - ").append(getJavaInfo()).append(" - ").append(getOSInfo());
		return sb.toString();
	} // getEnvInfo
	...
	/**
	 * Get 16x16 Image. Removing/modifying the Compiere logo is a violation of the
	 * license
	 * 
	 * @return Image Icon
	 */
	...
	public static Image getImageLogoSmall(boolean hr) {
		if (s_image48x15 == null) {
			...
			if (hr) {
				url = Compiere.class.getResource(s_fileHR);
			} else {
				url = Compiere.class.getResource(s_fileSmall);
			}
	...
	/**
	 * Get 32x32 ImageIcon. Removing/modifying the Compiere logo is a violation of
	 * the license
	 * 
	 * @return Image Icon
	 */
	...
	/**
	 * Get Medium ImageIcon. Removing/modifying the Compiere logo is a violation of
	 * the license
	 * 
	 * @return Image Icon
	 */
	...
	/*************************************************************************
	 * Startup Client/Server. - Print greeting, - Check Java version and - load Ini
	 * parameters If it is a client, load/set PLAF and exit if error. If Client, you
	 * need to call startupEnvironment explicitly! For testing call method
	 * startupEnvironment
	 * 
	 * @param isClient       true for client
	 * @param isUserProperty true if we should use the Compiere.properties in the
	 *                       user home directory, false if we should use the one in
	...
	/**
	 * Startup Compiere Environment. Automatically called for Server connections For
	 * testing call this method.
	 * 
