...
/**
 * Splash Screen. - don't use environment as not set up yet - <BR><BR>
 * <code>
 * 		Splash splash = new Splash("Processing");<BR>
...
public class Splash extends Frame {
	...
	private void jbInit() throws Exception {
		...
		//
		contentPanel.add(cImage, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(10, 5, 0, 10), 0, 0));
		contentPanel.add(productLabel, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
	...
	private class AImage extends Component {
		...
		public AImage() {
			super();
			URL url = Compiere.class.getResource("images/Java_anim.gif");
			if (url == null) {
				url = Compiere.class.getResource("images/Java_logo.gif");
			}
			if (url != null) {
