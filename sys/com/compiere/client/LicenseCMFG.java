...
final class LicenseCMFG
  implements LicenseInterface
{
  private CLogger log = CLogger.getCLogger(LicenseCMFG.class);
  ...
  public int getUnitOne()
  {
    ...
    catch (Exception localException1)
    {
      if ((j != 0) || (this.log != null))
        this.log.log(Level.SEVERE, z[0], localException1);
    }
    try
    {
  ...
  static
  {
    ...
    //   19: goto +10 -> 29
    //   22: aastore
    //   23: putstatic 101	com/compiere/client/LicenseCMFG:z	[Ljava/lang/String;
    //   26: goto +130 -> 156
    //   29: swap
