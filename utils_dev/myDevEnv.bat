...
@SET ANT_PROPERTIES=%ANT_PROPERTIES% -DMailLogger.mailhost=harry.han@gmail.com -DMailLogger.from=harry.han@gmail.com -DMailLogger.failure.to=harry.han@gmail.com -DMailLogger.success.to=harry.han@gmail.com

@Rem	Automatic Installation - Where Compiere2 will be unzipped
@SET COMPIERE_ROOT=D:\Java\Compiere_330\
