...
/**
 * Archive Engine. Based on Settings on Client Level Keys set for - Menu Reports
 * - AD_Report_ID - Win Report - AD_Table_ID - Documents - AD_Table_ID &
 * Record_ID & C_Customer_ID
 * 
 * @author Jorg Janke
...
public class ArchiveEngine {
	 ...
	 * @return existing document or newly created if Client enabled archiving. Will
	 *         return NULL if archiving not enabled
	 */
	...
	public static boolean isValid(LayoutEngine layout) {
		return (layout != null && Document.isValid(layout) && layout.getNumberOfPages() > 0);
	} // isValid
