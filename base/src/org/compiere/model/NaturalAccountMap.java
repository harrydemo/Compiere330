...
public final class NaturalAccountMap extends CCache<String, MElementValue> {
	 ...
	 * 
	 * @param line line with info Line format (9 fields) 1 A [Account Value] 2 B
	 *             [Account Name] 3 C [Description] 4 D [Account Type] 5 E [Account
	 *             Sign] 6 F [Document Controlled] 7 G [Summary Account] 8 H
	 *             [Default_Account] 9 I [Parent Value] - ignored
	 *
	 * @return error message or "" if OK
	 * @throws Exception
	 */
	public String parseLine(String line) throws Exception {
		...
		// Fill variables
		String Value = null, Name = null, Description = null, AccountType = null, AccountSign = null,
				IsDocControlled = null, IsSummary = null, Default_Account = null;
		//
...
//				H - Default_Account
		...
		try {
			// Try to find - allows to use same natutal account for multiple default
			// accounts
			MElementValue na = m_valueMap.get(Value);
			if (na == null) {
				// Create Account - save later
				na = new MElementValue(m_ctx, Value, Name, Description, AccountType, AccountSign,
