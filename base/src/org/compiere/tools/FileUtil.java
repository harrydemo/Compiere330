...
public class FileUtil {
	...
	/**************************************************************************
	 * Strip Latex specifics. \textsl{\colorbox{yellow}{\textbf{Important:}}} For
	 * more information on the installation of the Compiere Server and the Compiere
	 * Client please refer to
	 * \href{http://www.compiere.org/support/index.html}{Compiere Support} for more
	...
	/**************************************************************************
	 * File Filter. Accept directories and files matching filter
	 */
