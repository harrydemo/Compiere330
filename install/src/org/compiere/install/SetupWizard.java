 ...
 */
public class SetupWizard extends CFrame implements ActionListener, PropertyChangeListener {
	/** */
	...
	private void jbInit() throws Exception {
		...
		// Quit Dialog
		final JOptionPane optionPane = new JOptionPane("Do you want to quit Compiere Setup?\n",
		...
		titlePane.add(titleLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
		titlePane.add(titleIcon, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
				GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
	...
	public void propertyChange(PropertyChangeEvent evt) {
		 ...
		 * 
		 * // Switch to Progress if (newCard.equals(PROGRESS)) {
		 * progressPanel.init(this, p_properties); } else if
		 * (newCard.equals(COMPONENTS)) { componentPanel.init(this, p_properties); }
		 * else return;
		 * 
