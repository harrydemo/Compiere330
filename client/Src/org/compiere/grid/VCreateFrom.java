	...
	implements ActionListener, TableModelListener
{
	...
	protected JComboBox<NamePair> orderField = new JComboBox<NamePair>();
	protected JLabel invoiceLabel = new JLabel();
	protected JComboBox<Object> invoiceField = new JComboBox<Object>();
	protected JLabel shipmentLabel = new JLabel();
	protected JComboBox<NamePair> shipmentField = new JComboBox<NamePair>();
