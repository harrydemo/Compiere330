...
public abstract class VFormatValidator
{
	...
	static {
		...
		s_formatChars.put('c', 	new VFormatValidator('c'){
			...
			@Override
			public boolean isValid(char c) { return Character.isLetter(c) || Character.isDigit(c) || Character.isWhitespace(c); }
		});
		...
		s_formatChars.put('o', 	new VFormatValidator('o'){
			...
			public char getDefault() { return ' '; }
			@Override
			public boolean isValid(char c) { return Character.isLetter(c) || Character.isWhitespace(c); }
		});
		...
		s_formatChars.put('9', 	new VFormatValidator('9'){
			...
			public char getDefault() { return ' '; }
			@Override
			public boolean isValid(char c) { return Character.isDigit(c) || Character.isWhitespace(c); }
		});
